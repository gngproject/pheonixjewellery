      ...
      <div class="col-md-12 order-2">
        <div class="row">
          <div class="col-md-12 mb-5 mt-5">
            <div class="float-md-left mb-4"><h2 class="text-black h5">Product Man</h2></div>
            <div class="d-flex">
        ...
        <div class="row mb-5">
          ...
          <div class="col-sm-6 col-lg-4 mb-5 mt-5" data-aos="fade-up">
            <figure class="block-4-image text-center">
                <a href="shop-single.html"><img src="{{ url('assets/logo/LogoBlackText.png') }}" alt="Image placeholder"
                    class="img-fluid" style="width: 150px; height: auto;">
                </a>
            </figure>
            <div class="block-4 text-center border">
              <figure class="block-4-image">
                <a href="{{ route('Product.Detail',$items->productID) }}">
                  <img src="https://adminphoenixjewellery.com/{{$item['Product_img_1']}}" alt="Image placeholder" class="img-fluid">
                </a>
              </figure>
