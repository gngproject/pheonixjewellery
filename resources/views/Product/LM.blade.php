            ...
            <div class="col-md-12 order-2">
                <div class="row">
                    <div class="col-md-12 mb-5 mt-5">
                        <div class="float-md-left mb-4"><h2 class="text-black h5">Product LOGAM MULIA</h2></div>
                ...
                <div class="row text-center" data-aos="fade-up">
                    <div class="col-12 text-center">
                        {{ $itemsLM->links() }}
                        Displaying {{$itemsLM->count()}} of {{ $itemsLM->total() }} product(s).
                    </div>
                </div>
