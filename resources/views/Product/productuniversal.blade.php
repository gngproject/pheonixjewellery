            ...
            <div class="col-md-12 order-2">
                <div class="row">
                    <div class="col-md-12 mb-5 mt-5">
                        <div class="float-md-left mb-4"><h2 class="text-black h5">Universal Product All</h2></div>
                        <div class="d-flex">
                ...
                <div class="row mb-5">
                    @foreach ($getdataproductalluniversal as $items)
                    <div class="col-sm-6 col-lg-4 mb-5 mt-5" data-aos="fade-up">
                        ...
                        <div class="block-4 text-center border">
                            <figure class="block-4-image">
                                <a href="{{ route('Product.Detail',$items->productID) }}"><img src="https://adminphoenixjewellery.com/{{$items->Product_img_1}}" alt="Image placeholder" class="img-fluid"></a>
                            </figure>
                            <div class="block-4-text p-4">
                                <h3>
                                    <a href="{{ route('Product.Detail',$items->productID) }}">{{$items->Product_Name}}</a>
                                </h3>
                                ...
                                <form method="POST" action="{{route('cart.add')}}" class="form-inline">
                                    @csrf
                                    <input name="productID" type="hidden" value="{{$items->productID}}">
                                    <div class="col">
                                        <div class="row">
                ...
                <div class="row" data-aos="fade-up">
                    <div class="col-md-12 text-center">
                        {{ $getdataproductalluniversal->links() }}
                        Displaying {{$getdataproductalluniversal->count()}} of {{ $getdataproductalluniversal->total() }} product(s).
                    </div>
                </div>
            </div>
        </div>
