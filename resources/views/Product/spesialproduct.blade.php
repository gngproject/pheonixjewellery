    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-7 text-center pt-4 title">
                <img src="{{ url('assets/Icon/Title/SpecialProduct.png') }}" class="img-fluid rounded" alt="" srcset="">
            </div>
        </div>
        <div class="row justify-content-center text-center">
            <div class="col-sm-3" data-aos="fade" data-aos-delay="100">
                <a href="{{ url('/Special-Product/Logam-Mulia') }}">
                <figure class="image">
                    <img src="{{ url('assets/SpecialProduct/pict (1).png') }}" class="img-fluid">
                </figure>
                </a>
            </div>
            <div class="col-sm-3" data-aos="fade" data-aos-delay="100">
                <a href="#">
                <figure class="image">
                    <img src="{{ url('assets/SpecialProduct/pict (2).png') }}" class="img-fluid">
                </figure>
                </a>
            </div>
            <div class="col-sm-3" data-aos="fade" data-aos-delay="100">
                <a href="{{ url('/Special-Product/GIA') }}">
                <figure class="image">
                    <img src="{{ url('assets/SpecialProduct/pict (3).png') }}" class="img-fluid">
                </figure>
                </a>
            </div>
            <div class="col-sm-3" data-aos="fade" data-aos-delay="100">
                <a href="#">
                <figure class="image">
                    <img src="{{ url('assets/SpecialProduct/pict (4).png') }}" class="img-fluid">
                </figure>
                </a>
            </div>
        </div>
