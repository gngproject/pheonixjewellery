            ...
            <div class="col-md-12 order-2">
                <div class="row">
                    <div class="col-md-12 mb-5 mt-5">
                        <div class="float-md-left mb-4"><h2 class="text-black h5">Bundle Product</h2></div>
                        <div class="d-flex">
                    ...
                    <div class="col-sm-6 col-lg-4 mb-5 mt-5" data-aos="fade-up">
                        ...
                        <div class="block-4 text-center border">
                            <figure class="block-4-image">
                                <a href="{{ route('Product.Detail',$item->productID) }}"><img src="http://adminphoenixjewellery.com/{{$item->Product_img_1}}" alt="Image placeholder" class="img-fluid"></a>
                            </figure>
                ...
                <div class="row text-center" data-aos="fade-up">
                    <div class="col-12 text-center">
                        {{ $bundle->links() }}
                        Displaying {{$bundle->count()}} of {{ $bundle->total() }} product(s).
                    </div>
                </div>
